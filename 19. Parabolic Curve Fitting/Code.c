...
void upperTriangularMatrix(float arr[3][4] , float x[])
{
    int n = 3;
    for(int i = 0; i < n; i++)
    {
...
int main()
{
    ...
    float v[3];    
    upperTriangularMatrix(mat , v);
  
    printf("\nThe equation of the Parabola Curve is : \n");
    printf("And the form of equation is y = a + bx + cx^2 is : \n\n");
